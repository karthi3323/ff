...
if(isset($_GET['delete_id'])) {
    try {
        ...
        $items_query = "DELETE FROM ff_sch.temp_inv_items WHERE invoice_id = :invoice_id and fiscal_year_id= :fiscal_year_id";
        $items_stmt = $db->prepare($items_query);
        $items_stmt->bindParam(':invoice_id', $invoice_id);
        $items_stmt->bindParam(':fiscal_year_id', $current_fiscal_year_id);
        $items_stmt->execute();
        
        // Delete invoice
        $invoice_query = "DELETE FROM ff_sch.temp_inv WHERE id = :invoice_id and fiscal_year_id= :fiscal_year_id";
        $invoice_stmt = $db->prepare($invoice_query);
        $invoice_stmt->bindParam(':invoice_id', $invoice_id);
        $invoice_stmt->bindParam(':fiscal_year_id', $current_fiscal_year_id);
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="temp_add.php" class="btn btn-primary">
                    <i class="fas fa-plus me-2"></i>Invoice
                </a>
            </div>
        </div>
                    ...
                    <table class="table table-striped data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <strong><?php echo $invoice['party_id']; ?></strong>
                                        <br><small class="text-muted"><?php echo $invoice['p_state']; ?></small>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="temp_edit.php?id=<?php echo $invoice['invoice_no']; ?>&year=<?php echo $current_fiscal_year_id ; ?>" class="btn btn-warning me-2" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="rptt.php?id=<?php echo $invoice['invoice_no']; ?>&year=<?php echo $current_fiscal_year_id ; ?>" class="btn btn-info me-2" title="Print" target="_blank">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        <!-- <a href="view_details.php?id=<?php echo $invoice['invoice_no']; ?>&year=<?php echo $current_fiscal_year_id ; ?>" class="btn btn-primary" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a> -->
                                        <button type="button" 
                                                onclick="confirmDelete('Are you sure you want to delete invoice <?php echo $invoice['invoice_no']; ?>&year=<?php echo $current_fiscal_year_id ; ?>?', 'temp_view.php?delete_id=<?php echo $invoice['id']; ?>')" 
