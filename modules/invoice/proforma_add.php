...
$last_carton_query = $db->query("SELECT MAX(carton_to) as last_carton FROM ff_sch.proforma_invoice_items ii 
                                JOIN ff_sch.proforma_invoices i ON ii.invoice_id = i.id 
                                and i.fiscal_year_id = ii.fiscal_year_id
...
// Max Pro-forma Inv ID
$inv_query = $db->query("SELECT max(invoice_no) as count FROM ff_sch.proforma_invoices where fiscal_year_id ='".$current_fiscal_year_id."'");
$invoice = $inv_query->fetch(PDO::FETCH_ASSOC);
$max_id = $invoice['count']+1;

// Generate Pro-forma Invoice ID
$padded_max_id = str_pad($max_id, 5, '0', STR_PAD_LEFT);
// $invoice_no = "PRO-" . date('Y') . "-" . $padded_max_id;
$invoice_no = $max_id;
...
<head>
    ...
    <title>Add Pro-forma Invoice - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <?php if($_POST) {
        // Check duplicate pro-forma invoice number
        $check_sql = "SELECT 1 
                    FROM ff_sch.proforma_invoices 
        ...
        if ($check_stmt->fetch()) {
            echo "<script>
                    Swal.fire('Duplicate Pro-forma Invoice!', 
                    'Pro-forma invoice number already exists. Please use a different one.', 
                    'warning');
                </script>";
        } else {
            try {
                ...
                $invoice_query = "INSERT INTO ff_sch.proforma_invoices (
                    ...
                    additional_charges_percent, additional_charges_amount, packing_charges, agent_commission,
                ...
                // Insert pro-forma invoice items
                $items_query = "INSERT INTO ff_sch.proforma_invoice_items (
                ...
                echo "<script>
                        Swal.fire('Success!', 'Pro-forma invoice created successfully!', 'success')
                ...
                echo "<script>
                        Swal.fire('Error!', 'Failed to create pro-forma invoice: {$error_message}', 'error');
                        console.error('Pro-forma Invoice Error:', '{$error_message}');
                    </script>";
            }
        }
    } 
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2>Create New Pro-forma Invoice</h2>
        ...
        <form method="POST" id="invoiceForm" onkeydown="return event.key != 'Enter';">
                ...
                <div class="col-md-8 offset-md-4">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Hidden Fields -->
                            <input type="hidden" name="tax_type" id="tax_type" value="intrastate">
                            <input type="hidden" name="discount_type" id="discount_type" value="percent">
                            <input type="hidden" name="additional_charges_amount" id="additional_charges_amount" value="0">
                            <input type="hidden" name="packing_charges" id="packing_charges" value="0">
                            <input type="hidden" name="agent_commission" id="agent_commission" value="0">
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" id="goods_total_amount" value="0">
                                </div>

                                <div class="col-md-6 text-end">
                                    <span class="amount-display text-primary"
                                        id="goodsAmountDisplay">₹0.00</span>
                                </div>
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-5 text-end">
                                    <span class="amount-display text-primary"
                                        id="additionalChargesDisplay">₹0.00</span>
                                </div>
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-5 text-end">
                                    <span class="amount-display text-primary"
                                        id="packingChargesDisplay">₹0.00</span>
                                </div>
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-5 text-end">
                                    <span class="amount-display text-danger"
                                        id="agentCommissionDisplay">-₹0.00</span>
                                </div>
                            ...
                            <div class="row align-items-center border-top pt-4">
                                ...
                                <div class="col-md-6 text-end">
                                    <h2 class="mb-0 amount-display text-success"
                                        id="netAmountDisplay">₹0.00</h2>
                                </div>
            ...
            <div class="text-center d-flex justify-content-end">
                <button type="submit" class="btn btn-primary btn-lg me-3" >
                    <i class="fas fa-save"></i> Save Pro-forma Invoice
                </button>
            </div>
        </form>
    </div>
    ...
    function calculateGrandTotal() {
        ...
        $('#goods_total_amount').val(grandTotal.toFixed(2));
        calculateTax();
    }
    ...
    function calculateTax() {
        ...
        const grossAmount = additionalChargesAmount;
    ...
    $(document).ready(function() {
        ...
        $(document).on('change input', '#total_tax_input, #additional_charges_percent, #packing_charges_percent, #discount_value, #agent_commission_percent', function() {
            calculateTax();
        });
            ...
            $('#invoice_no').on('keyup blur', function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.exists == 'error') {
                            $('#invoiceHelp').text('Pro-forma invoice number already exists!');
