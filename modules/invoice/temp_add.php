...
$last_carton_query = $db->query("SELECT MAX(carton_to) as last_carton FROM ff_sch.temp_inv_items ii 
...
// Max Inv ID
$inv_query = $db->query("SELECT max(invoice_no) as count FROM ff_sch.temp_inv i WHERE i.fiscal_year_id = $current_fiscal_year_id");
...
<body>
    ...
    <?php if($_POST) {
        try {
            ...
            $invoice_query = "INSERT INTO ff_sch.temp_inv (
            ...
            $stmt->bindParam(':transport_name', $_POST['trans_name']);
            $stmt->bindParam(':transport_gst', $_POST['trans_gst']);
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" onkeypress="return isNumberKey(event);" name="eway" id="eway">
                                </div>
                                <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select transport-select" name="trans_name" id="trans_name">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="trans_gst" id="trans_gst" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $('#invoice_no').on('keyup blur', function () {
                ...
                // invoiceTimer = setTimeout(function () {
                    $.ajax({
                        ...
                        type: 'POST',
                        dataType: 'json',
                        data: { invoice_no: invoiceNo, fiscal_year_id: <?= $current_fiscal_year_id ?> ,source: 'temp'},
