...
// Base query
$query = "SELECT 
            i.id, i.invoice_no, i.invoice_date, p.name as party_name,
            i.taxable_amount, i.total_tax, i.net_amount, i.discount
...
$total_taxable = array_sum(array_column($invoices, 'taxable_amount'));
$total_net = array_sum(array_column($invoices, 'net_amount'));
$total_discount = array_sum(array_column($invoices, 'discount'));
$total_tax = array_sum(array_column($invoices, 'total_tax'));
...
<head>
    ...
    <title>Invoice Report - <?php echo SITE_NAME; ?></title>
    ...
    <div class="container-fluid">
                ...
                <div class="card shadow-sm">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="card-title text-muted mb-1">Invoices</h5>
                            <p class="card-text h4 fw-bold mb-0"><?php echo count($invoices); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="pdf_invoice_report.php?<?php echo http_build_query($_GET); ?>" class="btn btn-danger" target="_blank">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered data-table">
                        <thead>
                            <tr>
                                <th>Invoice #</th><th>Date</th><th>Party</th><th>Taxable</th><th>Net Amount</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end"><?php echo number_format($invoice['taxable_amount'], 2); ?></td>
                                <td class="text-end fw-bold"><?php echo number_format($invoice['net_amount'], 2); ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
